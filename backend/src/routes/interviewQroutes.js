...
import { limitInterviewGenerate } from "../middleware/rateLimiter.js";
const router3=express.Router();

router3.post("/generate/:resumeId",authMiddleware,limitInterviewGenerate,validate(generateInterviewSchema),InterviewQ);
