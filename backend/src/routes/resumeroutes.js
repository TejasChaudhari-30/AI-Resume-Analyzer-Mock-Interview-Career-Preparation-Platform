...
import { uploadResume ,deleteResume, getUserResumes, getResumeStatus} from "../controllers/resumeController.js";
...
import { limitResumeUpload,limitResumeReview } from "../middleware/rateLimiter.js";
...
router2.post("/review/:resumeId",authMiddleware,limitResumeReview,validate(resumeReviewSchema),review_resume);
...
router2.get("/status/:resumeId",authMiddleware,getResumeStatus);
